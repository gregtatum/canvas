...
const MASK_BOX_W = 0.3;
const MASK_BOX_H = 0.1;
const MASK_BOX_D = 0.3;
const MASK_THICKNESS = 0.2;
const EYE_HOLE_SIZE = 0.4;
const EYE_HEIGHT = 0.02;
const EYE_INSET_SCALE = 0.5;
const EYE_ROTATION = 0.4;
const EYE_SCALE = 1.1;
const SNOUT_WIDTH_SCALE = 0.65;
const SNOUT_DIP_DOWN = 0.13;
const CHEEK_WIDTH_SCALE = 1.2;
const CHEEK_PULL_DOWN = 0.08;
const HORN_BASE_WIDTH = 0.12;
const HORN_BASE_HEIGHT = 0.1;
const HORN_BASE_ROTATION_Z = rad(-0.25);
const HORN_BASE_ROTATION_X = rad(-0.2);
const HORN_BASE_POSITION = [0.11, 0.02, -0.24] as Tuple3;
const HORN_EXTRUSION_COUNT = 15;
const HORN_EXTRUSION_INSET = 0.1;
const HORN_EXTRUSION_EXTRUSION = 0.01;
const HORN_ROTATION_X = rad(-0.1);
const HORN_ROTATION_Y = rad(0.01);
const HORN_ROTATION_Z = rad(0);
const HORN_PUFF = true;
const HORN_PUFF_INSET = 0.8;
const HORN_PUFF_SCALE = 1.2;
const MODEL_ROTATE = rad(0.1);
const BODY_W = 0.16;
const BODY_H = 1.1;
const BODY_D = 0.4;
const BODY_X = 0;
